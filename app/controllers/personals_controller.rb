class PersonalsController < ApplicationController
  ...
  private
    ...
    def personal_params
      params.require(:personal).permit(:aygcode, :name, :dob, :doj, :contact1, :contact2, :email, :r_address, :r_area, :r_city, :r_state, :r_pincode, :profession, :bloodgroup, :pan, :married, :anniversary_date, :interest)
    end
end
