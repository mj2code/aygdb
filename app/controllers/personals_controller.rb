class PersonalsController < ApplicationController
  ...
  # GET /personals.json
  def index
    @personals = Personal.order("aygcode ASC")
  ...
  def ascname
      @personals = Personal.order("name ASC")
	render 'index'
  end
  # GET /personals/1
  ...
  private
    ...
    def personal_params
      params.require(:personal).permit(:aygcode, :name, :dob, :doj, :contact1, :contact2, :email, :r_address, :r_area, :r_city, :r_state, :r_pincode, :profesion, :bloodgroup, :pan, :married, :anniversary_date, :interest)
    end
end
