...
class ProfessionsControllerTest < ActionController::TestCase
  ...
  test "should create profession" do
    assert_difference('Profession.count') do
      post :create, profession: { designation: @profession.designation, jobdoj: @profession.jobdoj, org_name: @profession.org_name, org_station: @profession.org_station, prof_name: @profession.prof_name, salary: @profession.salary }
    end
  ...
  test "should update profession" do
    patch :update, id: @profession, profession: { designation: @profession.designation, jobdoj: @profession.jobdoj, org_name: @profession.org_name, org_station: @profession.org_station, prof_name: @profession.prof_name, salary: @profession.salary }
    assert_redirected_to profession_path(assigns(:profession))
  end
